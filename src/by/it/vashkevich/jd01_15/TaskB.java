...
public class TaskB {
    ...
    public static void main(String[] args) {
        String fileN = getFileName("TaskB.java");//getting filename
        readF(fileN);//reading&writing it to StringBuilder
        writeF();
        showF();
    }

    /**
     * @author Anastasiya Vashkevich
     * @version 2019_05_12
     * @file filename for reading in SB
     *
     */
    ...
    /*
     * Method returns true
     * if string doesn't contain cont and index
     */
