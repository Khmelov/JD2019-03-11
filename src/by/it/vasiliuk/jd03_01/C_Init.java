...
public class C_Init {
    ...
    public static void main(String[] args) throws SQLException {
        try (
            ...
            statement.executeUpdate("INSERT INTO `vasiliuk`.`users` (`ID`, `Login`, `Password`, `Email`, `roles_ID`) VALUES (DEFAULT, 'admin', 'admin', 'admin@gmail.com', 1);\n");
            statement.executeUpdate("INSERT INTO `vasiliuk`.`users` (`ID`, `Login`, `Password`, `Email`, `roles_ID`) VALUES (DEFAULT, 'user', 'user', 'user@mail.ru', 3);\n");
            statement.executeUpdate("INSERT INTO `vasiliuk`.`users` (`ID`, `Login`, `Password`, `Email`, `roles_ID`) VALUES (DEFAULT, 'user2', 'user2', 'user2@mail.ru', 3);\n");
