...
public class C_Init {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        Statement statement = connection.createStatement()
            ...
            statement.executeUpdate("INSERT INTO `bolotko`.`users` (`id`, `login`, `password`, `email`, `phone`, `roles_id`) VALUES (DEFAULT, 'admin', 'admin', 'kostja100pro@gmail.com', '+375297326543', 1);\n");
            statement.executeUpdate("INSERT INTO `bolotko`.`users` (`id`, `login`, `password`, `email`, `phone`, `roles_id`) VALUES (DEFAULT, 'nikolaj', 'jalokin', 'nikolajab@mail.ru', '+375335897326', 2);\n");
            statement.executeUpdate("INSERT INTO `bolotko`.`users` (`id`, `login`, `password`, `email`, `phone`, `roles_id`) VALUES (DEFAULT, 'dinis', 'sinid', 'dinis228@gmail.com', '+375442417438', 2);\n");
            statement.executeUpdate("INSERT INTO `bolotko`.`users` (`id`, `login`, `password`, `email`, `phone`, `roles_id`) VALUES (DEFAULT, 'moderator', 'moderator', 'moderator1@gmail.com', '+375297634920', 3);\n");
            statement.executeUpdate("INSERT INTO `bolotko`.`users` (`id`, `login`, `password`, `email`, `phone`, `roles_id`) VALUES (DEFAULT, 'moderator2', 'rotaredom2', 'moderator2@gmail.com', '+375297634921', 3);\n");
            statement.executeUpdate("INSERT INTO `bolotko`.`users` (`id`, `login`, `password`, `email`, `phone`, `roles_id`) VALUES (DEFAULT, 'user1', '0000', 'test1@yandex.ru', '+375297634900', 4);\n");
            statement.executeUpdate("INSERT INTO `bolotko`.`users` (`id`, `login`, `password`, `email`, `phone`, `roles_id`) VALUES (DEFAULT, 'user2', '0000', 'test2@yandex.ru', '+375297634900', 4);\n");
            statement.executeUpdate("INSERT INTO `bolotko`.`users` (`id`, `login`, `password`, `email`, `phone`, `roles_id`) VALUES (DEFAULT, 'maksim', 'miskam', 'maksim1997@mail.ru', '+375335356226', 2);\n");
            statement.executeUpdate("INSERT INTO `bolotko`.`cars` (`id`, `car_type`, `mark`, `model`, `year_of_issue`, `fuel_type`, `price`, `users_id`) VALUES (DEFAULT, 'passenger', 'Reno', 'Logan', '2009', 'petrol', 10100, 1);\n");
