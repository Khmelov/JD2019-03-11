...
public class C_Init {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        Statement statement = connection.createStatement()
            ...
            statement.executeUpdate("INSERT INTO `bolotko`.`users` (`id`, `login`, `password`, `email`, `phone`, `roles_id`) VALUES (DEFAULT, 'moderator1', 'rotaredom1', 'moderator1@gmail.com', '+375297634920', 3);\n");
